...
export default function FansAndBlowers({ portfolio, portfolios }) {
  return (
    <Layout>
      <Seo title={'Fans & Blowers'} />
      <main className='work__main work__main--fans'>
...
export async function getStaticProps({ params }) {
  ...
  const portfolio = portfolioData.data.filter(
    (item) => item.attributes.title === 'Fans & Blowers'
  );
